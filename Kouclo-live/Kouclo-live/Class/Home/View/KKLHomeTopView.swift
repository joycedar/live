...
//            
//            btn.tag = i
//            btn.frame = CGRect(x: btnW * CGFloat(i), y: 0, width: btnW, height: btnH)
//        
//            self.addSubview(btn)
//            btn.addTarget(self, action:  #selector(KKLHomeTopView.titleClick(btn:)), for: .touchUpInside)
//            if(i == 1 ){
//                let y:CGFloat = 40
//                let heihgt:CGFloat = 2
//                btn.titleLabel?.sizeToFit()
//                
//                self.lineView.height = heihgt
//                self.lineView.top = y
