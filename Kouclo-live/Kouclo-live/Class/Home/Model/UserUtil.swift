...
class UserProfileModel: NSObject {
    ...
    var fanList:[UserProfileModel]?
    var followList:[UserProfileModel]?
    var avaterUrL:String?
    var introduction:String?
    
    init(name:String , fansCount: NSNumber, followCount:NSNumber, fanList:[UserProfileModel]? ,followList:[UserProfileModel]?,avaterUrL:String?,introduction:String?) {
        self.name = name
