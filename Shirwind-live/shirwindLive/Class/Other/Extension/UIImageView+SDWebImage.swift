...
extension UIImageView {
    ...
    func downloadImage(url:String,placeholderImageName:String){
        ...
        self.sd_setImage(with: NSURL.init(string: url) as URL?,
                         placeholderImage: UIImage.init(named: placeholderImageName),
                         options: [SDWebImageOptions.retryFailed,SDWebImageOptions.lowPriority,.progressiveLoad])
    }
    ...
    func downloadImage(url:String,placeholderImageName:String,success:@escaping DownloadImageSuccessBlock,failed:@escaping DownloadImageFailedBlock,progress:@escaping DownloadImageProgressBlock){
        ...
        self.sd_setImage(with: NSURL.init(string: url) as URL?,
                         placeholderImage: UIImage.init(named: placeholderImageName),
                         options: [SDWebImageOptions.retryFailed,SDWebImageOptions.lowPriority,.progressiveLoad], progress: { (receivedSize, expectedSize,_)  in
